...
from app.services.metrics_service import MetricsCollector, get_metrics_collector, initialize_metrics_service
from app.core.health_checker import HealthChecker, ComponentStatus
    ...
    async def test_request_metrics_collection_positive_path(self, metrics_collector):
        ...
        for i in range(10):
            metrics_collector.record_request(
                endpoint=f"/api/v1/signals/greeks",
