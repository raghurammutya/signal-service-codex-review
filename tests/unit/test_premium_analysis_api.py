...
from app.api.v2.premium_analysis import router, premium_calculator
from app.services.premium_discount_calculator import MispricingSeverity
...
class TestPremiumAnalysisAPI:
    ...
    def test_premium_analysis_strike_range_success(self, client, mock_premium_calculator):
        ...
        mock_response = {
            ...
            'expiry_date': '2025-01-30',
            'underlying_price': 26000.0,
            'strike_range': {'min': 25800.0, 'max': 26200.0, 'step': 100.0},
            'strike_results': {
                '25900.0': {
                    'CE': {
                        'strike': 25900.0,
                    ...
                    'PE': {
                        'strike': 25900.0,
                        'market_price': 35.20,
                        'theoretical_price': 33.80,
                        'premium_percentage': 4.14,
                        'mispricing_severity': 'MEDIUM'
                    }
                }
            },
    ...
    def test_arbitrage_opportunities_severity_filtering(self, client):
        ...
        for severity in valid_severities:
            response = client.get(
                f"/api/v2/signals/fo/premium-analysis/arbitrage-opportunities/NIFTY",
