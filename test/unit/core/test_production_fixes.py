...
# Test imports
from app.core.redis_manager import get_redis_client, RedisConnectionError, RedisHealthChecker
from common.storage.database import get_database_connection, get_timescaledb_session, DatabaseConnectionError
from app.services.signal_redis_manager import SignalRedisManager, RedisClusterManager
...
class TestProductionFixesValidation:
    ...
    def test_sql_syntax_fix_in_repository(self):
        ...
        with open('/home/stocksadmin/signal-service-codex-review/app/repositories/signal_repository.py', 'r') as f:
            content = f.read()
...
"""
    ...
    def test_no_silent_fallbacks_in_production(self):
        ...
        with open('/home/stocksadmin/signal-service-codex-review/app/api/v2/websocket.py', 'r') as f:
