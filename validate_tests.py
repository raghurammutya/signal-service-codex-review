...
class TestValidator:
    ...
    def validate_test_files(self):
        ...
        core_components = [
            ...
            "services/moneyness_calculator_local.py",
            "services/market_profile_calculator.py", 
            "services/frequency_feed_manager.py",
            "scaling/consistent_hash_manager.py",
            "scaling/backpressure_monitor.py"
        ]
    ...
    def validate_test_content(self):
        ...
        try:
            ...
            print(f"📊 Actual Test Counts (via grep):")
