...
class Subscription:
    ...
    # Migration tracking
    migrated_from_token: str | None = None  # Track legacy token migration
    migration_timestamp: datetime | None = None

    # Internal fields - not exposed
    _registry_metadata: dict[str, Any] | None = None
    _delivery_endpoint: str | None = None
...
class SubscriptionStorage:
    ...
    async def create_subscription(self,
                                ...
                                expires_in_hours: int | None = None) -> Subscription:
        """
    ...
    async def get_user_subscriptions(self, user_id: str, status_filter: SubscriptionStatus | None = None) -> list[Subscription]:
