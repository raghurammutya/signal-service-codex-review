...
"""
        ...
        summary += "\n---\n\n## 🎯 Release Criteria\n\n"
        summary += "### Minimum Requirements (All Must Pass)\n"
        ...
        summary += "- [ ] Hot reload disabled by default\n"
        summary += "- [ ] External dependencies configured\n"
        summary += "- [ ] Monitoring and alerting ready\n"
        summary += "- [ ] Rollback plan validated\n"
        summary += "- [ ] Security posture verified\n"
