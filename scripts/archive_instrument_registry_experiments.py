...
def archive_experimental_directory():
    ...
    if experimental_dir.exists():
        ...
        if archive_location.exists():
            print("⚠️  Archive location exists, removing old archive...")
            shutil.rmtree(archive_location)

        print("📁 Moving experimental directory to archive...")
        ...
        if not symlink_path.exists():
            print("🔗 Creating informational symlink...")
...
"""
        ...
        print("✅ Experimental directory successfully archived!")
        return True

    print("ℹ️  Experimental directory not found - already archived or removed")
    return True
