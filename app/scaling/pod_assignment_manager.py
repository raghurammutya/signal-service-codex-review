...
class PodAssignmentManager:
    ...
    async def assign_instrument(self, instrument_key: str, preferred_pod: str = None) -> str | None:
        """
    ...
    async def reassign_instrument(self, instrument_key: str, exclude_pod: str = None) -> str | None:
    ...
    async def get_instrument_pod(self, instrument_key: str) -> str | None:
