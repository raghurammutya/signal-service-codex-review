...
from app.utils.logging_utils import log_info, log_warning, log_debug
...
class WorkStealingQueue:
    ...
    def _pop_local(self) -> Optional[ComputationTask]:
    ...
    async def _steal_work(self) -> Optional[ComputationTask]:
...
class WorkerPool:
    ...
    def _select_worker(self, task: ComputationTask) -> Optional[str]:
        ...
        elif self.distribution_strategy == 'hash':
