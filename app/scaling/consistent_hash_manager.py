...
class ConsistentHashManager:
    ...
    def get_node(self, key: str, exclude_nodes: Optional[List[str]] = None) -> Optional[str]:
    ...
    def get_nodes(self, key: str, count: int = 1, exclude_nodes: Optional[List[str]] = None) -> List[str]:
    ...
    def get_least_loaded_node(self, exclude_nodes: Optional[List[str]] = None) -> Optional[str]:
