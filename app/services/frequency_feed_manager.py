...
class FrequencyFeedManager:
    ...
    async def _compute_moneyness_greeks(self, moneyness_key: str) -> dict | None:
    ...
    async def _compute_indicators(self, instrument_key: str) -> dict | None:
    ...
    async def _compute_market_profile(self, instrument_key: str) -> dict | None:
