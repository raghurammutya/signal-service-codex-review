...
class AlertCondition:
    ...
    timeframe_minutes: Optional[int] = None  # Timeframe for condition evaluation
    # Metadata-based filters
    applies_to_sectors: Optional[List[str]] = None
    applies_to_exchanges: Optional[List[str]] = None
...
class AlertService:
    ...
    def __init__(self, instrument_client: Optional[InstrumentClient] = None):
        """
