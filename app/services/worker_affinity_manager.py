...
from app.services.ticker_stream_consumer import TickerStreamConsumer, TickerChannelSubscriber
...
class WorkerAffinityManager:
    ...
    def __init__(self, worker_id: Optional[str] = None):
        ...
        # Ticker consumers
        self.stream_consumer: Optional[TickerStreamConsumer] = None
        self.channel_subscriber: Optional[TickerChannelSubscriber] = None
