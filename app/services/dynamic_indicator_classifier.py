...
class MonitoringStrategy:
    ...
    frequency: Optional[str] = None        # For periodic monitoring
    max_latency_ms: int = 5000
    resource_allocation: str = "medium"    # 'minimal', 'low', 'medium', 'high'
    fallback_strategy: Optional[str] = None
    trigger: Optional[str] = None          # For on-demand monitoring
...
class DynamicIndicatorClassifier:
    ...
    def _determine_optimal_frequency(self, context: IndicatorClassificationContext) -> str:
        ...
        elif context.historical_breach_frequency < 1:  # <1 breach per day
...
class RealTimeAdaptationEngine:
    ...
    async def _detect_market_regime_change(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if market_data:
                ...
                elif data.get('volatility_change_pct', 0) < -30:
