...
class InstrumentServiceClient:
    ...
    async def calculate_moneyness(self, option_key: str, spot_price: float, method: str = "simple") -> dict[str, Any] | None:
    ...
    async def get_atm_iv(self, underlying_symbol: str, expiry_date: str, spot_price: float) -> float | None:
        """Get at-the-money implied volatility"""
        # Placeholder - would implement ATM IV retrieval
        return None
    ...
    async def get_moneyness_configuration(self) -> dict[str, Any]:
        ...
        raise RuntimeError("Moneyness configuration requires instrument service integration - default config removed")
