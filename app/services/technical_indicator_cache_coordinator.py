...
class TechnicalIndicatorCacheCoordinator:
    ...
    async def _calculate_indicator_value(self, indicator_type: IndicatorType, historical_data: List[Dict], timeframe: TimeFrame) -> Optional[Dict[str, Any]]:
    ...
    def _get_default_period(self, indicator_type: IndicatorType, timeframe: TimeFrame) -> int:
        ...
        if timeframe in [TimeFrame.MINUTE_1, TimeFrame.MINUTE_5]:
            return base_period
        elif timeframe in [TimeFrame.MINUTE_15, TimeFrame.HOUR_1]:
            return max(10, base_period // 2)
        elif timeframe in [TimeFrame.HOUR_4, TimeFrame.DAY_1]:
            return base_period
    ...
    async def _get_previous_market_data(self, instrument_id: str) -> Optional[Dict[str, Any]]:
        """Get previous market data for comparison"""
