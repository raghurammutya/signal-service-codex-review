...
from .enhanced_cache_invalidation_service import get_enhanced_cache_service
...
class MoneynessRefreshContext:
    ...
    spot_price: float
    spot_price_change_pct: float | None = None
...
class MoneynessCalculationEngine:
    ...
    async def calculate_option_moneyness(self, spot_price: float, strike_price: float,
                                       ...
                                       premium: float | None = None) -> MoneynessCalculationResult:
...
class MoneynessCache:
    ...
    async def get_moneyness_result(self, underlying: str, strike_price: float) -> dict[str, Any] | None:
...
class MoneynessRefreshService:
    ...
    async def handle_spot_price_update(self, underlying: str, new_spot_price: float,
                                     previous_spot_price: float | None = None) -> dict[str, Any]:
    ...
    async def _get_chain_data(self, underlying: str) -> dict[str, Any] | None:
    ...
    async def _get_current_spot_price(self, underlying: str) -> float | None:
