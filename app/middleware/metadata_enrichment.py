...
class MetadataCache:
    ...
    async def get(self, instrument_key: str) -> Optional[Dict[str, Any]]:
...
class MetadataEnrichmentMiddleware:
    ...
    def enrich_response(self, extract_keys_func: Optional[Callable] = None):
        """
    ...
    async def enrich_response_data(self,
                                 response: Any,
                                 extract_keys_func: Optional[Callable] = None) -> Any:
        """
    ...
    def _convert_metadata_to_dict(self, metadata) -> Dict[str, Any]:
        ...
        for field in ["market_cap", "industry", "currency", "timezone"]:
