...
class GreeksModelConfig:
    ...
    def __init__(self):
        ...
        self._greeks_functions: dict[str, Callable] | None = None
    ...
    def _load_model_functions(self) -> dict[str, Callable]:
        ...
        try:
            ...
            if self._model_name == "black_scholes":
...
# Global instance
_greeks_model_config: GreeksModelConfig | None = None
