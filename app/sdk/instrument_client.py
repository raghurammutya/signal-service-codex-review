...
class InstrumentMetadata:
    ...
    _broker_tokens: Optional[Dict[str, str]] = None
...
class InstrumentClient:
    ...
    def __init__(self, registry_client: Optional[InstrumentRegistryClient] = None):
    ...
    def accept_legacy_token(instrument_token: str) -> str:
        ...
        raise ValueError(
            f"Legacy token conversion not supported in Phase 1. "
            f"Please use instrument_key parameter. "
